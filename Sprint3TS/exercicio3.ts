...
import { contadorAte10 } from "./exercicio2.1";
import { numPares1a10 } from "./exercicio2.2";
import { numImpares50 } from "./exercicio2.3";
import { tabuada10 } from "./exercicio2.4";
import { Fibonacci } from "./exercicio2.5";
import { while20 } from "./exercicio2.6";
import { somaWhile100 } from "./exercicio2.7";
import { confirmarIdade } from "./exercicio2.8";
import { contRegressiva } from "./exercicio2.9";
import { numParDifZero1a10 } from "./exercicio2.10";
...
do {
    ...
    continuar = (prompt("Deseja escolher outro exercício? "))
} while (continuar === "s");
